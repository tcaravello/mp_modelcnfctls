...
if indic_emp == 0 && indic_models == 1 && indic_joint == 1
...
% hold on
for i_model = 1:n_models
    plot(0,0,settings.styles{i_model},'Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
jbfill(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),(pi_cnfctl_lb)',(pi_cnfctl_ub)',...
    settings.colors.lblue,settings.colors.lblue,0,1);
...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),pi_cnfctl_models(:,i_model),settings.styles{i_model},'Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),pi_hist_plot,'-','Color',settings.colors.black,'LineWidth',4)
...
title(series_names(1),'interpreter','latex','fontsize',24)
xlabel('Date','interpreter','latex','FontSize',20)
legend({'History','Forecast','RANK','HANK','B-RANK','B-HANK'},'Location','Southeast','fontsize',18,'interpreter','latex','NumColumns',2,'Orientation','horizontal')
grid on
hold off
...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),y_cnfctl_models(:,i_model),settings.styles{i_model},'Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),y_hist_plot,'-','Color',settings.colors.black,'LineWidth',4)
...
hold on
for i_model = 1:n_models
    plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),i_cnfctl_models(:,i_model),settings.styles{i_model},'Color',settings.colors.models(i_model,:),'LineWidth',4)
    hold on
end
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),i_hist_plot,'-','Color',settings.colors.black,'LineWidth',4)
...
print('scenario_2021_optpol_models','-dpng');
