...
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),pi_cnfctl_med,...
    '-','Color',settings.colors.orange,'LineWidth',4)
hold on
...
hold on
jbfill(0,0,0,settings.colors.lorange,settings.colors.lorange,0,1);
hold on
jbfill(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),(y_cnfctl_lb)',(y_cnfctl_ub)',...
    settings.colors.lorange,settings.colors.lorange,0,0.5);
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),y_cnfctl_med,...
    '-','Color',settings.colors.orange,'LineWidth',4)
hold on
...
legend({'History','Forecast','Counterfct''l'},'Location','Southeast','fontsize',18,...
    'NumColumns',3','Orientation','horizontal','interpreter','latex')
grid on
hold off
...
jbfill(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),(i_cnfctl_lb)',(i_cnfctl_ub)',...
    settings.colors.lorange,settings.colors.lorange,0,0.5);
hold on
plot(date_ext(fcst_date-fcst_lag):0.25:date_ext(fcst_date+fcst_hor),i_cnfctl_med,...
    '-','Color',settings.colors.orange,'LineWidth',4)
hold on
...
if save_fig == 1
print('scenario_2021_optpol_emp','-dpng');
end
