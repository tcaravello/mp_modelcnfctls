...
shocks_match = settings_MH.shocks_match;
...
if shocks_match == 2
    m_fit_collector  = zeros(T_use,2,N_keep);
    Pi_m_fit_collector  = zeros(T_use,2,N_keep);
    Y_m_fit_collector  = zeros(T_use,2,N_keep);
    R_n_m_fit_collector  = zeros(T_use,2,N_keep);
else
